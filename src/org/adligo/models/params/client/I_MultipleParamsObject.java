...
/**
 * Title:
 * Description:  This is a extension to the I_TemplateParams Object
 *               it adds the ability to add parameters to the Query Object
 *               and also manipulate the
 *               parameters of the Query Object
...
public interface I_MultipleParamsObject extends I_TemplateParams {
  ...
  /*
   * returns the last paramter found with
   * getNextParam(String s)
   */
  public I_TemplateParams getCurrentParam();
  /*
   * remove all refrences to this object
   * in the current I_MultipleParamsObject
   * does not recurse into child objects
   * 
   * this method will loose the place holder
   * used in getNextParam(String s)
   */
  public void removeParam(I_TemplateParams p);
  /*
   * remove all parameter objects with 
   * this name in the current I_MultipleParamsObject
   * does not recurse into child objects
   * 
   * this method will loose the place holder
   * used in getNextParam(String s)
